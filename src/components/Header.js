...
const Header = () => {
  ...
  return (
    <header>
      <nav  className=" bg-white border-b-2 border-gray-200 px-2 sm:px-4 py-2 dark:bg-gradient-to-r from-cyan-900 to-black  dark:border-b-1 dark:border-gray-900 sticky top-0 z-50">
        <div className=" flex flex-wrap justify-between items-center mx-auto">
            <Link to="/" className="flex items-center">
               <img 
               src={Logo}
               className="mr-2 h-8 sm:h-9 rounded-full"
               alt='Cine-Guide Logo'
               />
            ...
            <div className="relative mt-3 md:hidden">
                        ...
                        <ul className="flex flex-col p-4 mt-4 bg-gray-1000 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-1000 md:dark:bg-gray-800 dark:border-gray-700">
                            <li>
                                <NavLink
                                    to="/"
                                    className={({ isActive }) =>
